...
$LEVEL = substr($_SERVER['REQUEST_URI'], -1);
...
if($count<1){
    echo "<br><br><h1><center><span style=color:green>No Errors Found</span></center></h1><p></p><p></p>"; 
}
...
<hr>
<h1><center>Last 25 Messages - Severity <?php echo $LEVEL; ?></center><h1>
