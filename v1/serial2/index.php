...
//Serial Data for threeHours Avrages
	$CheckSerialDatathreeHours = "select size from traffic_mon2 ORDER by id DESC  LIMIT 18";
	...
	$CheckSerialDatatwoHours = "select size from traffic_mon2 ORDER by id DESC  LIMIT 12";
	...
	$CheckSerialDataHour = "select size from traffic_mon2 ORDER by id DESC  LIMIT 6";
	...
	$CheckALLData = "select * from traffic_mon2 ORDER by id DESC  LIMIT $SerialSizeRowCountWanted";
...
<html>
	...
	<?php if($UDPMonitorPage == "yes"){ ?>
	 ...
	 <?php if($SerialMonitorPage == "yes"  && ($MotorolaPage == "yes" || $UDPMonitorPage == "yes" || $ZabbixPage == "yes")){ ?>
	  <button style="background-color:yellow;border-radius: 6px;color:black"><a style="color:black;" href="../serial/index.php">Serial-Monitor Port 1</a></button>
	 <?php } ?>
	 <?php if($SerialMonitorPage == "yes"  && ($MotorolaPage == "yes" || $UDPMonitorPage == "yes" || $ZabbixPage == "yes")){ ?>
          <button style="background-color:yellow;border-radius: 6px;color:black"><a style="color:black;" href="../serial2/index.php">Serial-Monitor Port 2</a></butt>
         <?php } ?>
