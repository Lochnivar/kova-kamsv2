...
function getIPArray()
{
	...
	$ipArray = [
		"CSR" => [
			"ip" => "10.106.18.229",
			"servName" => "Lycoming-KAMS",
			"serials" => [
				"Port 1" => [
					"table" => "traffic_mon",
					"thresh" => 90000,
					"link" => "http://10.106.18.229/serial/index.php",
					"second" => "yes"
					],
				"Port 2" => [
					"table" => "traffic_mon2",
					"thresh" => 90000,
					"link" => "http://10.106.18.229/serial2/index.php"
					]
				]
			]
		];
...
function getHTMLHead()
{
	...
	<html>
	  <head>
		<meta
		  http-equiv="refresh"
		  content="600; URL=http://10.106.18.229/serial-unified/index.html"
		/>
